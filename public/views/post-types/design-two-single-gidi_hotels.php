...
<div class="gh-grid-wrapper gh-clearfix">
	<div class="gh-grid-eight">
		<div class="gh-tabs">
			<ul class="tabs wc-tabs">
				<li><a onclick="openCity(event, 'description')" class="gh-tab-links active">Description</a></li>
		...
		<div class="gh-tab-content">
			...
			<div class="tab-content" id="reviews">
				<h2>Reviews About this Hotel</h2>
				<?php 
			...
			<div class="tab-content" id="policies">
				<h2>Hotel Policies, Terms and Conditions</h2>
				<p>
